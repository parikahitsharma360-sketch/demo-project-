...
exports.createProducts = async(req, res) => {
    ...
    try {
        ...
        const{product_id, product_name, description, price, stock_quantity, category_id, url_image} = req.body

        const[result] = await db.query(

            'INSERT INTO products(product_id, product_name, description, price, stock_quantity, category_id, url_image)VALUES(? ? ?)'

            [product_id, product_name, description, price, stock_quantity, category_id, url_image]
        );
    ...
    try {
       ...
       [costumer_id, product_id]
        ...
        await Activity.create({
            ...
            discription: `costumer review in product$(product_id)`,
        ...
        res.status(201).json({
            ...
            message: 'costumer review submitted  sucessfully',
...
exports.deleteProduct = async(req, res) => {
    ...
    try {
        ...
        const[result] = db.query('DELETE FROM product WWERE product_id = ?'[req.params.body]);
